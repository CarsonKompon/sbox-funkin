...
{
	public partial class FunkinChatBox : Panel
	{
		static FunkinChatBox Current;

		public Panel Canvas { get; protected set; }
		public TextEntry Input { get; protected set; }

		public FunkinChatBox()
		{
			Current = this;

			StyleSheet.Load( "/ui/chat/FunkinChatBox.scss" );
		...
		{
			var e = Canvas.AddChild<FunkinChatEntry>();
			//e.SetFirstSibling();
