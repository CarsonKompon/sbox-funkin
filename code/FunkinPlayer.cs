...
public partial class FunkinPlayer : Player
{
    ...
    [Net] public bool Downscroll {get; set;} = false;
	...
	public override void Simulate( Client cl )
	{
        ...
        //     var _notes = FunkinGame.GetLobby(_steamid).NextNotes(Boyfriend.GetMustHit(_steamid));
